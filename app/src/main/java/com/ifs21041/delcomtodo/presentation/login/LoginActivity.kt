package com.ifs21041.delcomtodo.presentation.login
...
import com.ifs21041.delcomtodo.data.pref.UserModel
import com.ifs21041.delcomtodo.data.remote.MyResult
import com.ifs21041.delcomtodo.databinding.ActivityLoginBinding
import com.ifs21041.delcomtodo.presentation.main.MainActivity
import com.ifs21041.delcomtodo.presentation.register.RegisterActivity
            ...
            btnLogin.setOnClickListener {
                ...
                if (email.isEmpty() || password.isEmpty()) {
                    AlertDialog.Builder(this@LoginActivity).apply {
                        setTitle("Warning!")
                        setMessage("No empty data allowed!")
                        setPositiveButton("Understand") { _, _ -> }
                        create()
                        show()
                    }
