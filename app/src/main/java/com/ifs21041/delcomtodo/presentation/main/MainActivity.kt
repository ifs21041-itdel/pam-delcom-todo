package com.ifs21041.delcomtodo.presentation.main
...
import com.ifs21041.delcomtodo.adapter.TodosAdapter
...
import com.ifs21041.delcomtodo.data.remote.response.TodosItemResponse
import com.ifs21041.delcomtodo.databinding.ActivityMainBinding
import com.ifs21041.delcomtodo.helper.Utils.Companion.observeOnce
import com.ifs21041.delcomtodo.presentation.login.LoginActivity
                        ...
                        when (it) {
                            is MyResult.Error -> {
                                if (isChecked) {
                                    ...
                                    Toast.makeText(
                                        this@MainActivity,
                                        "Failed to cancel completiontodo: " + todo.title,
                                        Toast.LENGTH_SHORT
                                    ).show()
                                }
                            }
